...
<div class="container">
  <div class="mySlides">
    ...
    <img src="bmw11.jpg" style="width:100%">
  </div>

  <div class="mySlides">
   
    <img src="bmw12.jpg" style="width:100%">
  </div>

  <div class="mySlides">
  
    <img src="bmw13.jpg" style="width:100%">
  </div>
    
  <div class="mySlides">
    
    <img src="bmw14.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    
    <img src="bmw15.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="bmw11.jpg" style="width:100%" onclick="currentSlide(1)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw12.jpg" style="width:100%" onclick="currentSlide(2)">
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw13.jpg" style="width:100%" onclick="currentSlide(3)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw14.jpg" style="width:100%" onclick="currentSlide(4)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw15.jpg" style="width:100%" onclick="currentSlide(5)" >
    </div>    
...
<p style="color:#bb8847; text-align: center; margin-left:80px;margin-right: 80px;"> 
 As the name suggests this particular model is limited to only 100 units.
  Under the hood, the twin-turbo motor pushes out a herculean 610 horsepower which BMW claims will propel the
   massive limo to 60 mph from a standstill in a supercar-shaming 3.6 seconds.
   <br>
    In addition to the speed, the centennial 7-series limos are designed to show off 25 of BMW's most innovative
     technologies including carbon core construction, BMW e-Drive hybrid tech and gesture control.
 </p>
 <p style="color:#bb8847; text-align: left; margin-left:80px;margin-right: 80px;">
 <br>
    -A unique "Centennial Blue Metallic" paint finish.
<br>
  -ABS and driveline Traction control
<br>
   -Merino Smoke White leather upholstery, BMW Individual Black Piano Finish interior trim, and ‘1 of 100’ lettering on the floor console.
...
<tr ><td style="float: left;">HORSE POWER</td><td style="float:right;">610</td></tr>
<tr ><td style="float: left;">ENGINE size</td><td style="float:right;">6.6 Liter M Performance</td></tr>
<tr ><td style="float: left;">Color</td><td style="float:right;">blue</td></tr>
...
<input type='hidden' name='MODEL' value='M760'>
