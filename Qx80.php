...
<script src="https://www.gstatic.com/firebasejs/7.13.2/firebase-app.js"></script>
	...
	<script>
			storageRef.child('/in1.jpg').getDownloadURL().then(function(url) {
				...
				var img = document.getElementById('in1');
				img.src = url;
	...
	<script>
			storageRef.child('/in2.jpg').getDownloadURL().then(function(url) {
				// `url` is the download URL for 'images/stars.jpg'
				...
				// Or inserted into an <img> element:
				var img = document.getElementById('in2');
				img.src = url;
			}).catch(function(error) {
			// Handle any errors
			});
	...
	<script>
			storageRef.child('/in3.jpg').getDownloadURL().then(function(url) {
				// `url` is the download URL for 'images/stars.jpg'
				...
				// Or inserted into an <img> element:
				var img = document.getElementById('in3');
				img.src = url;
			}).catch(function(error) {
			// Handle any errors
			});
	...
	<script>
			storageRef.child('/in4.jpg').getDownloadURL().then(function(url) {
				// `url` is the download URL for 'images/stars.jpg'
				...
				// Or inserted into an <img> element:
				var img = document.getElementById('in4');
				img.src = url;
			}).catch(function(error) {
			// Handle any errors
			});
	...
	<script>
			storageRef.child('/in5.jpg').getDownloadURL().then(function(url) {
				// `url` is the download URL for 'images/stars.jpg'
				...
				// Or inserted into an <img> element:
				var img = document.getElementById('in5');
				img.src = url;
			}).catch(function(error) {
			// Handle any errors
			});
...
<div class="container">
  ...
  <div class="mySlides">
    ...
    <img src="in4.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    
    <img src="in5.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="in1.jpg" style="width:100%" onclick="currentSlide(1)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="in2.jpg" style="width:100%" onclick="currentSlide(2)">
    </div>
    <div class="column">
      <img class="demo cursor" src="in3.jpg" style="width:100%" onclick="currentSlide(3)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="in4.jpg" style="width:100%" onclick="currentSlide(4)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="in5.jpg" style="width:100%" onclick="currentSlide(5)" >
    </div>    
...
<tr ><td style="float: left;">YEAR</td><td style="float:right;">2018</td></tr>
<tr ><td style="float: left;">CLASS</td><td style="float:right;">SUV</td></tr>
<tr ><td style="float: left;">HORSE POWER</td><td style="float:right;">400</td></tr>
<tr ><td style="float: left;">ENGINE size</td><td style="float:right;">5.6L V8</td></tr>
...
<tr ><td style="float: left;">Seats</td><td style="float:right;">7</td></tr>
<tr ><td style="float: left;"> Cylinders</td><td style="float:right;">8<td></tr>
<tr ><td style="float: left;">specs</td><td style="float:right;">GCC</td></tr>
</table>
</center>
<center>
<form method=POST>
<input type='hidden' name='BRAND' value='INFINITY'>
<input type='hidden' name='MODEL' value='Qx80'>
