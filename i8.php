...
<div class="container">
  <div class="mySlides">
    ...
    <img src="bmw21.jpg" style="width:100%">
  </div>

  <div class="mySlides">
   
    <img src="bmw22.jpg" style="width:100%">
  </div>

  <div class="mySlides">
  
    <img src="bmw23.jpg" style="width:100%">
  </div>
    
  <div class="mySlides">
    
    <img src="bmw24.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    
    <img src="bmw25.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="bmw21.jpg" style="width:100%" onclick="currentSlide(1)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw22.jpg" style="width:100%" onclick="currentSlide(2)">
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw23.jpg" style="width:100%" onclick="currentSlide(3)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw24.jpg" style="width:100%" onclick="currentSlide(4)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="bmw25.jpg" style="width:100%" onclick="currentSlide(5)" >
    </div>    
...
<tr ><td style="float: left;">YEAR</td><td style="float:right;">2015</td></tr>
<tr ><td style="float: left;">CLASS</td><td style="float:right;">Coupe</td></tr>
<tr ><td style="float: left;">HORSE POWER</td><td style="float:right;">362</td></tr>
<tr ><td style="float: left;">ENGINE size</td><td style="float:right;">1.5L Hybrid Turbocharge i3</td></tr>
...
<tr ><td style="float: left;"> Cylinders</td><td style="float:right;">3<td></tr>
...
<input type='hidden' name='MODEL' value='i8'>
