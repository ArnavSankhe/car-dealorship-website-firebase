...
<div class="model">
<h2 style="margin-right: 120px;text-transform:uppercase; " class="generalTitle">
...
<div class="container">
  <div class="mySlides">
    ...
    <img src="jeep11.jpg" style="width:100%">
  </div>

  <div class="mySlides">
   
    <img src="jeep12.jpg" style="width:100%">
  </div>

  <div class="mySlides">
  
    <img src="jeep13.jpg" style="width:100%">
  </div>
    
  <div class="mySlides">
    
    <img src="jeep14.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    
    <img src="jeep15.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="jeep11.jpg" style="width:100%" onclick="currentSlide(1)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="jeep12.jpg" style="width:100%" onclick="currentSlide(2)">
    </div>
    <div class="column">
      <img class="demo cursor" src="jeep13.jpg" style="width:100%" onclick="currentSlide(3)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="jeep14.jpg" style="width:100%" onclick="currentSlide(4)" >
    </div>
    <div class="column">
      <img class="demo cursor" src="jeep15.jpg" style="width:100%" onclick="currentSlide(5)" >
    </div>    
...
<tr ><td style="float: left;">mileage</td><td style="float:right;">605</td></tr>
<tr ><td style="float: left;">HORSE POWER</td><td style="float:right;">470</td></tr>
<tr ><td style="float: left;">ENGINE size</td><td style="float:right;">392 Hemi 6.4 Liter V8</td></tr>
<tr ><td style="float: left;">Color</td><td style="float:right;">green</td></tr>
...
<input type='hidden' name='MODEL' value='Wrangler4x4'>
